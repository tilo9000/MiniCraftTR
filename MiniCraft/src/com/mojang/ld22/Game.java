...
public class Game extends Canvas implements Runnable {
	...
	private void init() {
		...
		try {
			screen = new Screen(WIDTH, HEIGHT, new SpriteSheet(ImageIO.read(Game.class.getResourceAsStream(ResourceManager.getResFileName(ResourceManager.RES_ICONS)))));
			lightScreen = new Screen(WIDTH, HEIGHT, new SpriteSheet(ImageIO.read(Game.class.getResourceAsStream(ResourceManager.getResFileName(ResourceManager.RES_ICONS)))));
		} catch (IOException e) {
			e.printStackTrace();
		}
